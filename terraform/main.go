...
//go:generate openapi-terraform-provider-generator -api=gitlab.com/KopiCloud/kopicloud-ad-tf-provider/api -package=provider -include computer -generate=schemas -o provider/kopicloud.schemas.gen.go -url https://labapi.kopicloud-ad-api.com/swagger/v1/swagger.json
