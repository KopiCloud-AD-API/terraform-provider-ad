...
//go:generate openapi-terraform-provider-generator resource-crud 														      --api github.com/KopiCloud-AD-API/terraform-provider-ad/api -p provider -o provider/kopicloud.computer-cleanup-crud.gen.go  -i generator-inputs/computer_cleanup.json
...
//:generate openapi-terraform-provider-generator resource-crud 														      --api github.com/KopiCloud-AD-API/terraform-provider-ad/api -p provider -o provider/kopicloud.user-password-reset-crud.gen.go -i generator-inputs/user_password_reset.json
