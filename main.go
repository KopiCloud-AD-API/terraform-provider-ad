...
//go:generate openapi-terraform-provider-generator resource-crd 														      --api gitlab.com/KopiCloud/kopicloud-ad-tf-provider/api -p provider -o provider/kopicloud.computer-cleanup-crd.gen.go  -i generator-inputs/computer_cleanup.json

// Generate the Code for Groups Memberships
//go:generate openapi-terraform-provider-generator resource-crd 														      --api gitlab.com/KopiCloud/kopicloud-ad-tf-provider/api -p provider -o provider/kopicloud.group-memberships-crd.gen.go 	 -i generator-inputs/group_membership.json
...
//go:generate openapi-terraform-provider-generator resource-crd 														      --api gitlab.com/KopiCloud/kopicloud-ad-tf-provider/api -p provider -o provider/kopicloud.security-group-crd.gen.go 	 -i generator-inputs/security_group.json
...
//:generate openapi-terraform-provider-generator resource-crd 														      --api gitlab.com/KopiCloud/kopicloud-ad-tf-provider/api -p provider -o provider/kopicloud.user-crd.gen.go 	     		 -i generator-inputs/user.json
//:generate openapi-terraform-provider-generator resource-update 														      --api gitlab.com/KopiCloud/kopicloud-ad-tf-provider/api -p provider -o provider/kopicloud.user-update.gen.go 		 	 -i generator-inputs/user.json
